        ...
        <>
            <main>
                <div className="row pt-3">
                    <div className="col-2 pt-5 links-div">
                                ...
                                <div id="collapseTwo" className="accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                                    <div className="accordion-body">
                                        <ul className="list-group">
                                            ...
                                            <li className="list-group-item">Customize</li>
                                            <li className="list-group-item">Layout</li>
                                            <li className="list-group-item">Content</li>
                                            <li className="list-group-item">Forms</li>
                                            <li className="list-group-item">Components</li>
                                            <li className="list-group-item">Helpers</li>
                                            <li className="list-group-item">Utilities</li>
                                            <li className="list-group-item">Extend</li>
                                            <li className="list-group-item">About</li>
                                            <li className="list-group-item">Migration</li>
                                            <li className="list-group-item">Customize</li>
                                            <li className="list-group-item">Layout</li>
                                            <li className="list-group-item">Content</li>
                                            <li className="list-group-item">Forms</li>
